...
function easy_breadcrumbs() {
  /* === ОПЦИИ === */
  $text['home'] = 'ZhivotBoka.ru'; // текст ссылки "Главная"
...
class RandomPostWidget extends WP_Widget
{
  ...
  {
    $widget_ops = array('classname' => 'widget-last-news', 'description' => 'Displays a random post with thumbnail' );
...
?>
  ...
  function widget($args, $instance)
  {
    ...
    if ( have_posts() ) {
      ...
      echo sprintf('<div class="last-news">
        <a href="%s">
